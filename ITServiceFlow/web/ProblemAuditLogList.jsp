                                    ...
                                    <div class="row align-items-center">
                                        <div class="col-md-12">
                                            ...
                                            <ul class="breadcrumb">
                                                ...
                                                <li class="breadcrumb-item"><a href="ProblemDetail?Id=${problem.id}">Activity List</a></li>
                                ...
                                <div class="col-sm-12">
                                    <div class="card">
                                        <div class="card-header d-flex justify-content-between align-items-center">
                                            <h5 class="m-0">Problem Activity History</h5>
                                        </div>
                                        ...
                                        <div class="card-body table-border-style">
                                            ...
                                            <c:if test="${empty auditLogs}">
                                                <div class="alert alert-warning">
                                                    No activity history found for this Problem
                                                </div>
                                            </c:if>
