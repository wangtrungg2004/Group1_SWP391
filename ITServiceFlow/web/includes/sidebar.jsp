        ...
        <div class="navbar-content scroll-div">
            <ul class="nav pcoded-inner-navbar">
                <c:if test="${role == 'Admin'}">
                    ...
                    <li class="nav-item">
                        <a href="UserCreate" class="nav-link"><span class="pcoded-micon"><i class="feather icon-users"></i></span><span class="pcoded-mtext">Quan ly User</span></a>
                    </li>
                    <li class="nav-item">
                        <a href="SystemSettings" class="nav-link"><span class="pcoded-micon"><i class="feather icon-settings"></i></span><span class="pcoded-mtext">Cai dat he thong</span></a>
                    </li>
                </c:if>
