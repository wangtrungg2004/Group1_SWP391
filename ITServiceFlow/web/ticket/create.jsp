...
<head>
    ...
    <style>
        ...
        .file-upload-wrapper { border: 2px dashed #dfe1e6; border-radius: 8px; padding: 20px; text-align: center; background-color: #fafbfc; transition: 0.2s; }
        .file-upload-wrapper:hover { border-color: #0052cc; background-color: #f4f5f7; }
