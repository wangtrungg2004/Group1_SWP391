<%-- Top bar (header) - thanh trên cùng. Sử dụng request attribute "notifications" nếu có (tùy chọn). Tên user có thể
    lấy từ session "user" (model.Users) hoặc "userName" . --%>
                                        ...
                                        <c:choose>
                                            <c:when test="${empty notifications}">
                                                <li class="notification">
                                                    <p class="text-muted m-2">No notifications</p>
                                                </li>
                                            </c:when>
                                            <c:otherwise>
                            ...
                            <div class="dropdown drp-user">
                                ...
                                <div class="dropdown-menu dropdown-menu-right profile-notification">
                                    ...
                                    <ul class="pro-body">
                                        ...
                                        <li><a href="Logout" class="dropdown-item"><i class="feather icon-log-out"></i>
                                                Logout</a></li>
                                    </ul>
                                </div>
                            </div>
