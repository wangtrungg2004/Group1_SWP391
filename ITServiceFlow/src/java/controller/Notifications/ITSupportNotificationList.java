 ...
 * @author DELL
 */
@WebServlet(name = "ITSupportNotificationList", urlPatterns = {"/ITSupportNotificationList"})
public class ITSupportNotificationList extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            out.println("<html>");
            out.println("<head>");
            out.println("<title>Servlet ITSupportNotificationList</title>");
            out.println("</head>");
            out.println("<body>");
            out.println("<h1>Servlet ITSupportNotificationList at " + request.getContextPath() + "</h1>");
            out.println("</body>");
            out.println("</html>");
        }
    }
