...
<c:set var="isBreached" value="${not empty slaTracking and not empty slaTracking.resolutionDeadline and slaTracking.resolutionDeadline.time < now.time}" />
<!DOCTYPE html>
<html lang="en">
    <head>
        <meta charset="utf-8">
            ...
            <div class="pcoded-wrapper">
                        ...
                        <div class="main-body">
                            <div class="page-wrapper p-0">
                                ...
                                <c:if test="${not empty slaTracking}">
                                    <div class="alert ${isBreached ? 'alert-danger' : 'alert-warning'} p-3 mb-4 border-0 d-flex justify-content-between align-items-center" style="border-radius: 6px;">
                                        <div>
                                        ...
                                        <c:if test="${isBreached && ticket.status != 'Resolved' && ticket.status != 'Closed'}">
                                            ...
                                            <div class="card-body p-4 p-md-5">
                                                ...
                                                <div class="ticket-header d-flex justify-content-between align-items-start">
                                                    ...
                                                    <div class="d-flex align-items-center">
                                                            ...
                                                            <c:when test="${ticket.status == 'Awaiting Approval'}">
                                                                <c:choose>
                                                                    <c:when test="${isManager}">
                                                                        <button type="button" class="btn btn-sm btn-success font-weight-bold shadow-sm mr-2" data-toggle="modal" data-target="#approveModal">
                                                                            <i class="feather icon-check-circle mr-1"></i> Approve
                                                                        </button>
                                                                        <button type="button" class="btn btn-sm btn-danger font-weight-bold shadow-sm mr-2" data-toggle="modal" data-target="#rejectModal">
                                                                    ...
                                                                    <c:when test="${canEdit}">
                                                                        <div class="dropdown mr-2">
                                                                            ...
                                                                            <div class="dropdown-menu dropdown-menu-right mt-1 shadow-sm">
                                                                                ...
                                                                                <c:if test="${ticket.status == 'New' || ticket.status == 'Reopened' || ticket.status == 'In Progress'}">
                                                                                    <c:choose>
                                                                                        <c:when test="${isBreached}">
                                                                                            <a class="dropdown-item text-danger font-weight-bold py-2" href="javascript:void(0)" data-toggle="modal" data-target="#breachResolveModal">
                                                                                                <i class="feather icon-alert-octagon mr-2"></i> Resolve (SLA Breached)
                                                                                            </a>
                                                                                        </c:when>
                                                                                        <c:otherwise>
                                                                                            <a class="dropdown-item text-success font-weight-bold py-2" href="${pageContext.request.contextPath}/UpdateStatus?id=${ticket.id}&status=Resolved">
                                                                                                <i class="feather icon-check-circle mr-2"></i> Mark as Completed
                                                                                            </a>
                                                                                        </c:otherwise>
                                                                                    </c:choose>
                                                                                </c:if>
                                                                                
                                                                                <a class="dropdown-item text-secondary py-2" href="${pageContext.request.contextPath}/UpdateStatus?id=${ticket.id}&status=Closed">
                                                                                    <i class="feather icon-archive mr-2"></i> Close
                                                                                </a>
                                                                            </div>
                                                                        </div>
                                                                    </c:when>
                                                                    ...
                                                                    <c:otherwise>
                                                                        <div class="alert alert-secondary py-2 px-3 mb-0 mr-2 border d-flex align-items-center shadow-sm" style="font-size: 0.85rem; background: #fff;">
                                                                            ...
                                                                            <c:choose>
                                                                                ...
                                                                                <c:otherwise>
                                                                                    <span>Read Only. Ticket is handled by <strong>${ticket.assigneeName}</strong>.</span>
                                                                                </c:otherwise>
                                                                            </c:choose>
                                                                        </div>
                                                                    </c:otherwise>
                                                        ...
                                                        <c:if test="${canEdit && ticket.status != 'Closed' && ticket.status != 'Resolved'}">
                                                            <c:if test="${ticket.ticketType == 'Incident' and (empty ticket.parentTicketId or ticket.parentTicketId == 0)}">
                                                                <button type="button" data-toggle="modal" data-target="#linkChildModal" class="btn btn-sm btn-outline-secondary bg-white font-weight-bold mr-2" title="Link Child Incidents">
                                                                    <i class="feather icon-layers mr-1"></i> Link Incidents
                                                                </button>
                                                            </c:if>

                                                            <c:if test="${sessionScope.role == 'IT Support'}">
                                                                <a href="${pageContext.request.contextPath}/SubmitChangeRequest?sourceTicketId=${ticket.id}" class="btn btn-sm btn-outline-danger bg-white font-weight-bold">
                                    ...
                                    <div class="col-lg-4">
                                        <div class="card border-0">
                                            <div class="card-body p-4 position-relative">
                                                ...
                                                <c:if test="${sessionScope.role eq 'IT Support' || isManager}">
                                                    <div class="mt-4 pt-3 border-top">
                                                        ...
                                                        <c:choose>
                                                            <c:when test="${ticket.status eq 'Resolved' and canEdit}">
                                                            ...
                                                            <c:otherwise>
                                                                <div class="p-2 mb-3 rounded text-center" style="background:#f4f5f7; border:1px dashed #dfe1e6; font-size:0.78rem; color:#a5adba;">
                                                                    <i class="feather icon-lock mr-1"></i> Locked (Available only when Resolved)
                                                                </div>
                                                            </c:otherwise>
                                                        </c:choose>
                    ...
                    <div class="modal-dialog modal-dialog-centered" role="document">
                        <div class="modal-content border-0 shadow-lg" style="border-radius: 8px;">
                            <div class="modal-header bg-light border-bottom-0 p-4">
                                <h5 class="modal-title font-weight-bold text-success"><i class="feather icon-check-circle mr-2"></i>Approve Ticket</h5>
                            ...
                            <form action="${pageContext.request.contextPath}/ProcessApproval" method="POST">
                                <div class="modal-body p-4 text-center">
                                    ...
                                    <h6 class="font-weight-bold text-dark">Confirm approval for this ticket?</h6>
                                    <p class="text-muted small mb-0">The system will process the approval and calculate SLA automatically.</p>
                                </div>
                ...
                <div class="modal fade" id="rejectModal" tabindex="-1" role="dialog" aria-hidden="true">
                    <div class="modal-dialog modal-dialog-centered" role="document">
                        <div class="modal-content border-0 shadow-lg" style="border-radius: 8px;">
                            <div class="modal-header bg-light border-bottom-0 p-4">
                                <h5 class="modal-title font-weight-bold text-danger"><i class="feather icon-x-circle mr-2"></i>Reject Ticket</h5>
                                <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
                            </div>
                            <form action="${pageContext.request.contextPath}/ProcessApproval" method="POST">
                                <div class="modal-body p-4">
                                    ...
                                    <div class="form-group mb-0">
                                        ...
                                        <textarea name="rejectReason" class="form-control" rows="4" placeholder="e.g., Not enough details, Invalid request..." required style="border-radius: 6px;"></textarea>
                                    </div>
                                </div>
                                <div class="modal-footer border-top-0 p-4 pt-0">
                                    <button type="button" class="btn btn-light font-weight-bold px-4" data-dismiss="modal">Cancel</button>
                                    <button type="submit" class="btn btn-danger font-weight-bold px-4 shadow-sm">Reject Ticket</button>
                                </div>
                            </form>
                        </div>
                    </div>
                ...
                <div class="modal fade" id="breachResolveModal" tabindex="-1" role="dialog" aria-hidden="true">
                    <div class="modal-dialog modal-dialog-centered" role="document">
                        <div class="modal-content border-0 shadow-lg" style="border-radius: 8px;">
                            <div class="modal-header bg-light border-bottom-0 p-4">
                                <h5 class="modal-title font-weight-bold text-danger"><i class="feather icon-alert-octagon mr-2"></i>SLA Breached Resolution</h5>
                                <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
                            </div>
                            <form action="${pageContext.request.contextPath}/UpdateStatus" method="POST">
                                <div class="modal-body p-4">
                                    ...
                                    <div class="alert alert-danger p-3 mb-4 border-0" style="border-radius: 6px;">
                                        <i class="feather icon-alert-triangle font-weight-bold mr-2"></i>
                                        <strong>SLA Target Missed!</strong> This ticket has exceeded its resolution deadline. ITIL policy requires a Root Cause Analysis (RCA) or reason for delay before closing.
                                    </div>

                                    <div class="form-group mb-0">
                                        <label class="font-weight-bold text-dark mb-2">Reason for Delay (Root Cause) <span class="text-danger">*</span></label>
                                        <p class="text-muted small mb-3">This note will be saved internally for audit and performance reviews.</p>
                                        <textarea name="breachReason" class="form-control" rows="4" placeholder="e.g., Awaiting 3rd party vendor, High volume of critical incidents..." required style="border-radius: 6px;"></textarea>
                                    </div>
                                </div>
                                <div class="modal-footer border-top-0 p-4 pt-0">
                                    <button type="button" class="btn btn-light font-weight-bold px-4" data-dismiss="modal">Cancel</button>
                                    <button type="submit" class="btn btn-danger font-weight-bold px-4 shadow-sm">Submit & Resolve</button>
                                </div>
                            </form>
                        </div>
                    </div>
                ...
                <script>
                    ...
                    $(document).ready(function () {
                        ...
                        function filterSubCategories(parentId, preSelectId) {
                            ...
                            $subSelect.append('<option value="" disabled>-- Select Sub-Category --</option>');
                            ...
                            if (filteredCats.length > 0) {
                                ...
                                $subSelect.append('<option value="" disabled>-- No sub-category available --</option>');
                        ...
                        $('#editMainCategory').on('change', function () {
                            ...
                            if (newParentId) filterSubCategories(newParentId, 0);
                        });
