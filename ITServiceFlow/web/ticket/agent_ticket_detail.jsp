...
<html lang="en">
    <head>
        ...
        <style>
            ...
            .comment-tab.active-reply {
                background: #e9f2ff;
                color: #0052cc;
            }
            .comment-tab.active-note {
                background: #fff0b3;
                color: #ff8b00;
            }
            .editor-area {
            ...
            .editor-area.note-mode {
                background-color: #fffdf5;
                border-color: #ffc400;
            }
            .editor-area.note-mode:focus {
                                                        ...
                                                        <div class="d-flex align-items-center">
                                                            <c:choose>
                                                                ...
                                                                <c:when test="${ticket.status == 'Awaiting Approval'}">
                                                                    <%-- Chỉ Manager mới thấy nút duyệt (Dùng session role) --%>
                                                                ...
                                                                <%-- KỊCH BẢN 2: VÉ BÌNH THƯỜNG (WORKFLOW CŨ CỦA BẠN) --%>
                                                                <c:otherwise>
