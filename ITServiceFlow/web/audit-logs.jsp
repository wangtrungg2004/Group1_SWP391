                                                        ...
                                                        <div class="card-body">
                                                            <form action="AuditLogs" method="get" class="form-inline">
                                                                 <div class="form-group mb-2 mr-2">
                                                                    <label for="userName" class="mr-2">User:</label>
                                                                    <input type="text" class="form-control" name="userName" placeholder="All Users" value="${userName}">
                                                                </div>
                                                                 <div class="form-group mb-2 mr-2">
                                                                    <label for="action" class="mr-2">Action:</label>
                                                                    <select class="form-control" name="action">
                                                                        <option value="">All</option>
                                                                        <c:forEach items="${distinctActions}" var="act">
                                                                            <option value="${act}" ${act == action ? 'selected' : ''}>${act}</option>
                                                                        </c:forEach>
                                                                    </select>
                                                                </div>
                                                                <div class="form-group mb-2 mr-2">
                                                                ...
                                                                <nav aria-label="Page navigation">
                                                                    <ul class="pagination justify-content-end">
                                                                        <c:if test="${currentPage > 1}">
                                                                            <li class="page-item">
                                                                                 <a class="page-link"
                                                                                    href="AuditLogs?page=${currentPage - 1}&userName=${userName}&action=${action}&from=${from}&to=${to}">Previous</a>
                                                                            </li>
                                                                        </c:if>
                                                                        <c:forEach begin="1" end="${totalPages}"
                                                                            ...
                                                                            <li
                                                                                class="page-item ${i == currentPage ? 'active' : ''}">
                                                                                 <a class="page-link"
                                                                                    href="AuditLogs?page=${i}&userName=${userName}&action=${action}&from=${from}&to=${to}">${i}</a>
                                                                            </li>
                                                                        </c:forEach>
                                                                        <c:if test="${currentPage < totalPages}">
                                                                            <li class="page-item">
                                                                                 <a class="page-link"
                                                                                    href="AuditLogs?page=${currentPage + 1}&userName=${userName}&action=${action}&from=${from}&to=${to}">Next</a>
                                                                            </li>
                                                                        </c:if>
                                                                    </ul>
                                                                </nav>
